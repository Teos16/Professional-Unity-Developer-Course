...
namespace Game.Gameplay
{
    public sealed class TowerInstaller : GameEntityInstaller
    {
        ...
        public override void Install(IGameEntity entity)
        {
            ...
            entity.GetRotateCommand().AddCondition(_ => entity.IsHealthExists());
            entity.GetRotateCommand().AddAction(entity.RotateStep);
            entity.AddRotationSpeed(_rotateSpeed);
            
            _healthInstaller.Install(entity);
            _takeDamageInstaller.Install(entity);
            
            entity.GetTakeDamageCommand().AddAction(damage => entity.ReduceHealth(damage));
