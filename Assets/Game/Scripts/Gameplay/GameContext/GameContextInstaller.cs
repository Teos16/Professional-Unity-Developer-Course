...
namespace Game.Gameplay
{
    public sealed class GameContextInstaller : SceneEntityInstaller<IGameContext>
    {
        ...
        [SerializeField]
        private PrefabEntityPool _prefabPool;
        ...
        public override void Install(IGameContext gameContext)
        {
            ...
            gameContext.AddLeaderboard(new ReactiveDictionary<TeamType, int>());
            
            this.InstallPlayers(gameContext);
        ...
        private void InstallPlayers(IGameContext gameContext)
        {
            ...
            var playerMap = new Dictionary<TeamType, IPlayerContext>();
