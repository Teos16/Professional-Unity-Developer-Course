...
namespace SampleGame
{
    public sealed class CommandMarkerView : MonoBehaviour
    {
        ...
        [SerializeField] private ParticleSystem _patrolMarkerPrefab;
        [SerializeField] private ParticleSystem _holdPositionPrefab;
        [SerializeField] private ParticleSystem _followMarkerPrefab;
        [SerializeField] private ParticleSystem _attackMarkerPrefab;
