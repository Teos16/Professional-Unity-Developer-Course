...
namespace Game
{
    public sealed class OverlapDetectComponent : MonoBehaviour
    {
        [Title("Area")]
        ...
        {
            int count = Physics2D.OverlapBox(_point.position, _size, 0f, _contactFilter, _results);
            results = _results;
            return count;
        }
        ...
        private void OnDrawGizmos()
        {
            ...
            Gizmos.DrawWireCube(_point.position, new Vector3(_size.x, _size.y, 0));
        }
    }
}