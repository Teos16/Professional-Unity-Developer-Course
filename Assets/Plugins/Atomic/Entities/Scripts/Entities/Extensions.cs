...
namespace Atomic.Entities
{
    ...
    public static partial class Extensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool AddTag(this IEntity entity, TagKey tagKey) =>
            entity.AddTag(tagKey.Id);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool AddTag(this IEntity entity, TagKey tagKey, out int id)
        {
            id = tagKey.Id;
            return entity.AddTag(id);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool DelTag(this IEntity entity, TagKey tagKey) =>
            entity.DelTag(tagKey.Id);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool HasTag(this IEntity entity, TagKey tagKey) =>
            entity.HasTag(tagKey.Id);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void AddValue<T>(this IEntity entity, ValueKey<T> valueKey, object value) =>
            entity.AddValue(valueKey.Id, value);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void AddValue<T>(this IEntity entity, ValueKey<T> valueKey, object value, out int id)
        {
            id = valueKey.Id;
            entity.AddValue(id, value);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void AddValue<T>(this IEntity entity, ValueKey<T> valueKey, T value) where T : struct =>
            entity.AddValue(valueKey.Id, value);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void AddValue<T>(this IEntity entity, ValueKey<T> valueKey, T value, out int id) where T : struct
        {
            id = valueKey.Id;
            entity.AddValue(id, value);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool DelValue<T>(this IEntity entity, ValueKey<T> valueKey) =>
            entity.DelValue(valueKey.Id);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T GetValue<T>(this IEntity entity, ValueKey<T> valueKey) =>
            entity.GetValue<T>(valueKey.Id);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool TryGetValue<T>(this IEntity entity, ValueKey<T> valueKey, out T value) =>
            entity.TryGetValue(valueKey.Id, out value);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetValue<T>(this IEntity entity, ValueKey<T> valueKey, T value) where T : struct =>
            entity.SetValue(valueKey.Id, value);
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetValue<T>(this IEntity entity, ValueKey<T> valueKey, object value) =>
            entity.SetValue(valueKey.Id, value);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool HasValue<T>(this IEntity entity, ValueKey<T> valueKey) =>
            entity.HasValue(valueKey.Id);
