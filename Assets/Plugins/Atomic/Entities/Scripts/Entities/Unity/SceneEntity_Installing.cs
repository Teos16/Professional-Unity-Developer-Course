...
namespace Atomic.Entities
{
    public partial class SceneEntity
    {
        ...
        {
            InstallAll<SceneEntity>(scene, includeInactive);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void InstallAll<E>(Scene scene, bool includeInactive = false) where E : SceneEntity
        {
        ...
        {
            SceneEntity[] entities = component.GetComponentsInChildren<SceneEntity>(includeInactive);
